...
На диаграммах изображены сущности данных. В коде они реализованы с использованием декоратора `@dataclass`, что является оптимальным способом описания структур данных в Python.
